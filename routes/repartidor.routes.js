...
router.patch('/:id/registrar-entrega', /*authMiddleware.autenticar, authMiddleware.autorizar(['admin', 'sistema_pedidos']),*/ repartidorController.registrarEntregaRepartidor); // Esta ruta debería ser llamada por el sistema de pedidos
